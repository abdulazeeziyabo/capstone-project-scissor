<template>
    ...
    <routerLink to="/profile-page" class="flex items-center h-full border-b-[3px] border-[#f2f3f4] py-9 cursor-pointer">Profile </routerLink>
    </div>
    <div class="flex gap-8 items-center">
      <div class="mt-9 rounded-full mx-auto mb-10 cursor-pointer flex items-center gap-2"
>
      <span class="text-bold">{{ profile.displayName }}</span>
      <span
